...
To initialize your local repository using the AOSP trees to build OFRP, use a command like this:
    ...
    repo init -u git://github.com/Ctapchuk/platform_manifest_ofrp_aosp.git -b ofrp-12.1

To initialize a shallow clone, which will save even more space, use a command like this:

    repo init --depth=1 -u git://github.com/Ctapchuk/platform_manifest_ofrp_aosp.git -b ofrp-12.1
